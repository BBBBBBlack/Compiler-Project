...
void setRules(ParseTab &parseTab)
{
    ...
    rules.push_back(Rule({"basics", {"void"}, [&](Token &leftToken, std::vector<Token> &rightTokens) -> int
                          {
                              leftToken.value = "basics";
                              return 0;
                          }}));
    ...
    rules.push_back(Rule({"array_init", {"num"}, [&](Token &leftToken, std::vector<Token> &rightTokens) -> int
                          {
                              leftToken.value = "B";
                              return 0;
                          }}));
    rules.push_back(Rule({"array_init", {"array_init", ",", "id"}, [&](Token &leftToken, std::vector<Token> &rightTokens) -> int
                          {
                              leftToken.value = "B";
                              return 0;
                          }}));
    rules.push_back(Rule({"array_init", {"id"}, [&](Token &leftToken, std::vector<Token> &rightTokens) -> int
                          {
                              leftToken.value = "B";
                              return 0;
                          }}));
    rules.push_back(Rule({"array_declaration", {"basics", "id", "[", "num", "]"}, [&](Token &leftToken, std::vector<Token> &rightTokens) -> int
                          {
                              leftToken.value = "array_declaration";
                              return 0;
                          }}));
    rules.push_back(Rule({"array_declaration", {"basics", "id", "[", "num", "]", "=", "{", "array_init", "}"}, [&](Token &leftToken, std::vector<Token> &rightTokens) -> int
                          {
                              leftToken.value = "B";
                              return 0;
                          }}));
    rules.push_back(Rule({"array_declaration", {"basics", "id", "[", "id", "]", "=", "{", "array_init", "}"}, [&](Token &leftToken, std::vector<Token> &rightTokens) -> int
                          {
                              leftToken.value = "B";
                              return 0;
                          }}));
    rules.push_back(Rule({"array_assignment", {"id", "[", "num", "]", "=", "expr", ";"}, [&](Token &leftToken, std::vector<Token> &rightTokens) -> int
                          {
                              leftToken.value = "array_assignment";
                              return 0;
                          }}));
    rules.push_back(Rule({"array_assignment", {"id", "[", "id", "]", "=", "expr", ";"}, [&](Token &leftToken, std::vector<Token> &rightTokens) -> int
                          {
                              leftToken.value = "B";
                              return 0;
                          }}));
    ...
    rules.push_back(Rule({"expr", {"{", "expr", "}"}, [&](Token &leftToken, std::vector<Token> &rightTokens) -> int
                          {
                              leftToken.value = "B";
                              return 0;
                          }}));
