...
void setRules(ParseTab &parseTab)
{
    ...
    rules.push_back(Rule({"stmts", {"stmt", "stmts"}, [&](Token &leftToken, std::vector<Token> &rightTokens, std::vector<std::pair<int, Token>> &tokenStack, std::vector<std::pair<std::string, std::string>> &tempToken) -> int
                          {
                              return 0;
                          }}));
    ...
    rules.push_back(Rule({"stmt", {"id", "=", "expr", ";"}, [&](Token &leftToken, std::vector<Token> &rightTokens, std::vector<std::pair<int, Token>> &tokenStack, std::vector<std::pair<std::string, std::string>> &tempToken) -> int
                          {
                              return 0;
                          }}));
    rules.push_back(Rule({"expr", {"expr", "+", "expr"}, [&](Token &leftToken, std::vector<Token> &rightTokens, std::vector<std::pair<int, Token>> &tokenStack, std::vector<std::pair<std::string, std::string>> &tempToken) -> int
                          {
                              return 0;
                          }}));
    rules.push_back(Rule({"expr", {"expr", "-", "expr"}, [&](Token &leftToken, std::vector<Token> &rightTokens, std::vector<std::pair<int, Token>> &tokenStack, std::vector<std::pair<std::string, std::string>> &tempToken) -> int
    ...
    rules.push_back(Rule({"expr", {"-", "expr"}, [&](Token &leftToken, std::vector<Token> &rightTokens, std::vector<std::pair<int, Token>> &tokenStack, std::vector<std::pair<std::string, std::string>> &tempToken) -> int
                          {
                              return 0;
                          }}));
    rules.push_back(Rule({"expr", {"(", "expr", ")"}, [&](Token &leftToken, std::vector<Token> &rightTokens, std::vector<std::pair<int, Token>> &tokenStack, std::vector<std::pair<std::string, std::string>> &tempToken) -> int
    ...
    rules.push_back(Rule({"expr", {"id"}, [&](Token &leftToken, std::vector<Token> &rightTokens, std::vector<std::pair<int, Token>> &tokenStack, std::vector<std::pair<std::string, std::string>> &tempToken) -> int
                          {
                              return 0;
                          }}));
    rules.push_back(Rule({"expr", {"num"}, [&](Token &leftToken, std::vector<Token> &rightTokens, std::vector<std::pair<int, Token>> &tokenStack, std::vector<std::pair<std::string, std::string>> &tempToken) -> int
                          {
                              return 0;
                          }}));
