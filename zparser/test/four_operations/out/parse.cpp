...
void setRules(ParseTab &parseTab)
{
    ...
    rules.push_back(Rule({"E", {"E", "+", "E"}, [&](Token &leftToken, std::vector<Token> &rightTokens) -> int
                          {
    ...
    rules.push_back(Rule({"E", {"(", "E", ")"}, [&](Token &leftToken, std::vector<Token> &rightTokens) -> int
                          {
    ...
    rules.push_back(Rule({"E", {"digit"}, [&](Token &leftToken, std::vector<Token> &rightTokens) -> int
                          {
